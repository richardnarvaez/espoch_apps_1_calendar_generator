            ...
            <>
              ...
              <div className="container" style={{ paddingTop: 150 }}>
                ...
                <div className="mb-5 no-print" style={{ textAlign: 'center', }}>
                  ...
                  <p >Crea tu horario de clases en pocos segundos.</p>
                </div>
            ...
            }}>
              {
                authUser != null ? <Link to={ROUTES.HOME} style={{ height: '100%' }}>
                  <div className="card" style={{ width: '18rem', height: '100%' }} >
                    <Link to={ROUTES.SIGN_OUT} className="no-print" data-toggle="tooltip" data-placement="top" title="Cerrar sesión" style={{
                      position: 'absolute',
                      background: "#fff",
                      padding: 8,
                      top: 8,
